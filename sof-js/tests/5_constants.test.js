...
import { start_case, end_case, add_test, add_throwing_test, invalid_view } from './test_helpers.js'
...
describe('constant', () => {
  ...
  add_test({
    ...
    expect: [{ name: 'Smith' }, { name: 'Block' }, { name: 'Johnson' }],
  })
